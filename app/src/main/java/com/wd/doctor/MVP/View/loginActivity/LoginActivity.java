...
public class LoginActivity extends BaseActivity<LoginPresenter> implements LoginContracter.ILoginView {
    ...
    public void onLoginSuccess(Object data) {
        ...
        spUtils.putString("Id", mLoginBean.getResult().getId() + "");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.login_et_email:
                logingEmailHong.setVisibility(View.GONE);
                break;
            case R.id.login_et_pwd:
                logingPwdHong.setVisibility(View.GONE);
                break;
            ...
            case R.id.login_bt_but:
                ...
                if (!mEmail.isEmpty() || !mPwd.isEmpty()) {
                    ...
                    if (!mEmail.isEmpty()) {
                        ...
                        logingEmailHong.setVisibility(View.VISIBLE);
                    }
                    if (!mPwd.isEmpty()) {

                    } else {
                        logingPwdHong.setVisibility(View.VISIBLE);
                    }
